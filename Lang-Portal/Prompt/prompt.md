...
We would like to build a Kannada language learning web app.

## Project Description

### Project Brief
We are building a kannada language learning web-app which serves the following purposes:
- A portal to launch study activities.
- To store , group and explore the kannada langauge vocab
- To review the study progress

It is an desktop only web app , so dont need to think about optimization for mobile.
...
-Each of them are a page and we will describe them in details under the page heading
...
- Kannada: The kannada word with its vyakarana 
  - This will also contain a small button to play the sound of the word
  - The kannada word will be a link to the Words Show page
